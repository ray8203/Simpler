...
using Simpler.Application.SystemManage;
using Simpler.Code;
using Simpler.Application;

namespace Simpler.Web.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult CheckLogin(string username, string password, string code)
        {
            ...
            try
            {
                if (Session["Simpler_session_verifycode"].IsEmpty() || Md5.md5(code.ToLower(), 16) != Session["Simpler_session_verifycode"].ToString())
                {
