...
namespace Simpler.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "Simpler_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("Simpler_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("Simpler_licence", Licence.GetLicence());
        }
